...
@Api(value = Tag.CUISINE_TYPES)
public interface CuisineTypesApi {

    @ApiOperation(value = "Get cuisine types", nickname = "getCuisineTypes", notes = "Search cuisine types in a specific language. ", response = CuisineType.class, responseContainer = "List", tags = {Tag.CUISINE_TYPES})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Add a cuisine type", nickname = "addCuisineType", notes = "Add a new cuisine type.   You can add multiple languages in a single request. English (en) is mandatory. ", tags = {Tag.CUISINE_TYPES})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Get a cuisine type by id", nickname = "getCuisineType", notes = "Search for a cuisine type in a specific language. ", response = CuisineType.class, tags = {Tag.CUISINE_TYPES})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Update a cuisine type", nickname = "updateCuisineType", notes = "Update a cuisineType.    You can add more languages to a exist cuisine type with Accept-Language header.", tags = {Tag.CUISINE_TYPES})
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Delete a cuisine type", nickname = "deleteCuisineType", notes = "Delete a cuisine type. ", tags = {Tag.CUISINE_TYPES})
    @ApiResponses(value = {
