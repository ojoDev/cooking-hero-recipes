...
public class RecipesExamples {
	...
	public static final String RECIPE_NAME_01 = "Spanish omelet";
	public static final String RECIPE_DESCRIPTION_01 = "Classic Spanish omelet filled with pan-fried potatoes and onion.";
